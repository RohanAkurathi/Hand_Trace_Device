...
type Props = NativeStackScreenProps<RootStackParamList, "SpiralResults">;

const formatScore = (value: number) => `${Math.round(value)} / 100`;
const formatPercent = (value: number) => `${value.toFixed(1)}%`;
const formatPx = (value: number) => `${value.toFixed(1)} px`;

export default function SpiralResultsScreen({ navigation, route }: Props) {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.title}>Spiral Results</Text>
